const en = {
  ...
  about: {
    ...
    updateCheckingDescription: 'Aurora checks for a new version when you open the About page.',
    updateLatest: 'You are up to date',
    updateLatestDescription: 'The current version is already the latest version.',
    updateAvailable: 'Version {{version}} is available',
    updateAvailableToast: 'Version {{version}} is available',
    updateAvailableDescription:
      'Aurora can download and install the update automatically, then restart.',
    updateFailed: 'Update check failed',
    updateFailedDescription: 'Try again later, or check GitHub Releases manually.',
    updateCheckFailed: 'Update check failed: {{message}}',
    updateInstallFailed: 'Update install failed: {{message}}',
    updateInstalled: 'Update installed. Restarting Aurora.',
    updateVersionWithNotes: 'v{{version}} release notes',
