const zhCN = {
  ...
  about: {
    ...
    updateCheckingDescription: 'Aurora 会在进入关于页面时自动检查是否有新版本。',
    updateLatest: '已经是最新版本',
    updateLatestDescription: '当前版本已是最新版本。',
    updateAvailable: '发现新版本 {{version}}',
    updateAvailableToast: '发现新版本 {{version}}',
    updateAvailableDescription: '可以自动下载并安装新版本，安装完成后会重启 Aurora。',
    updateFailed: '检查更新失败',
    updateFailedDescription: '请稍后重试，或前往 GitHub Releases 手动查看。',
    updateCheckFailed: '检查更新失败：{{message}}',
    updateInstallFailed: '安装更新失败：{{message}}',
    updateInstalled: '更新已安装，正在重启',
    updateVersionWithNotes: 'v{{version}} 更新内容',
